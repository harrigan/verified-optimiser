...
//
// Vendored unmodified from https://github.com/boundless-xyz/steel
// (tag v2.4.3, contracts/src/Steel.sol), matching the risc0-steel crate
// version pinned in prover/Cargo.lock.  The soldeer risc0-ethereum package
// does not ship the Steel Solidity library.
